...
class CoutriesVC: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    
    let cellIDTitle = "title"
    let cellID = "cellID"
    
    let data = ["Россия", "Украина", "Грузия", "Эстония", "Литва", "Латвия", "Саудовская Аравия", "Израиль"]
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
         ...
         case 0:
             ...
             case 0:
                cellTitle.labelUpper.text = "Выбирите страну"
